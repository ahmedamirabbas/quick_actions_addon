...
![Quick Actions Panel](https://via.placeholder.com/800x400?text=Quick+Actions+Panel+Screenshot)
...
1. Download the latest release from [Itch.io](YOUR_ITCH_LINK)
...
**Author:** Amir 
**Version:** 1.0.0  
**Support:** [X](httsp://x.com/ahmedamirdev)
